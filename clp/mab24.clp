...
(deftemplate  monkey
  (slot  location (type SYMBOL) (default green-couch))
...
(deftemplate  thing
  ...
  (slot  location (type SYMBOL) (default ?NONE))
  (slot  on-top-of (type SYMBOL) (default floor))
  (slot  weight (type SYMBOL) (allowed-symbols light heavy) (default light))
)
...
(deftemplate  goal-is-to
  (multislot  action (type SYMBOL) (allowed-symbols hold unlock eat move on walk-to)
  (default ?NONE))
...
=>
(user-log "MAB" (str-cat "Monkey throws the " ?chest " off the " 
              ?on " onto the floor." ))
...
=>
(user-log "MAB" (str-cat "Monkey opens the " ?name " with the " ?key 
...
=>
(user-log "MAB" (str-cat "Monkey grabs the " ?name "."))
...
=>
(user-log "MAB" (str-cat "Monkey drops the " ?name "."))
  (modify ?monkey (holding blank))
...
=>
(user-log "MAB" (str-cat "Monkey walks to " ?place "."))
...
=>
(user-log "MAB" (str-cat "Monkey walks to " ?place " holding the " ?obj "."))
  (modify ?monkey (location ?place))
  (retract ?goal))
...
=>
(user-log "MAB" (str-cat "Monkey jumps off the " ?on " onto the floor."))
...
?goal <- (goal-is-to (action on) (arguments ?obj))
  ...
  ?monkey <- (monkey (location ?place) (on-top-of ?on) (holding blank))
=>
(user-log "MAB" (str-cat "Monkey climbs onto the " ?obj "."))
...
?goal <- (goal-is-to (action eat) (arguments ?name))
  ...
  ?thing <- (thing (name ?name))
=>
(user-log "MAB" (str-cat "Monkey eats the " ?name "."))
  (modify ?monkey (holding blank))
  (retract ?goal ?thing))
